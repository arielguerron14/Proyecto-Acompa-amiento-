...
def connect_and_execute():
    ...
    try:
        ...
        commands = [
            ...
            "cd ~/Proyecto-Acompa-amiento- && sudo docker-compose -f docker-compose.core.yml down",
            "sleep 3",
            "cd ~/Proyecto-Acompa-amiento- && sudo docker-compose -f docker-compose.core.yml up -d",
            "sleep 15",
            "docker ps -a --format 'table {{.Names}}\t{{.Status}}'"
        ]
