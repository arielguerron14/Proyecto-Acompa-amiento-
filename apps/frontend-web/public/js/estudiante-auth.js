...
class AuthManager {
    constructor() {
        ...
        this.user = null;
        // Prefer configured API base; fallback to localhost in dev
        this.baseURL = (window.API_CONFIG && window.API_CONFIG.API_BASE) ? window.API_CONFIG.API_BASE : 'http://localhost:8080';
    }
